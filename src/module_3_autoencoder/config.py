...
FEATURE_INTERPRETATIONS = {
    "wer_score": "content discrepancy between ASR and VSR",
    "semantic_anomaly": "decrease in audio-visual semantic consistency",
    "temporal_anomaly": "decrease in audio-visual temporal synchronization",
    "min_temporal_anomaly": "weakest temporal synchronization score within the chunk",
    "max_blur_flicker": "blur fluctuation between frames",
    "blur_flicker_variance": "variance of blur fluctuation",
    "max_texture_flicker": "surface texture fluctuation",
    "asymmetry_max": "facial region texture asymmetry",
    "mean_landmark_jitter": "average landmark jitter",
    "max_kinematic_flicker": "facial geometric motion fluctuation",
    "max_rigid_violation": "violation of rigid landmark motion",
    "gaze_anomaly": "decrease in consistency between gaze direction and head pose",
    "iris_jitter_variance": "abnormal iris-region jitter",
    "vocal_jitter_relative": "micro-fluctuation in voice frequency",
    "vocal_shimmer_relative": "micro-fluctuation in voice amplitude",
}